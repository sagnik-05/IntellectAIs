...
export declare const authAuthHeaderMissing: () => string;
export declare const infiniteRedirectLoopDetected: () => string;
export declare const informAboutProtectedRouteInfo: (path: string, hasPublicRoutes: boolean, hasIgnoredRoutes: boolean, defaultIgnoredRoutes: string[]) => string;
