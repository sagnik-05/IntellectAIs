...
class Portal extends import_react.default.PureComponent {
  ...
  render() {
    return /* @__PURE__ */ import_react.default.createElement("div", { ref: this.portalRef });
  }
}
...
const UserProfile = (0, import_withClerk.withClerk)(({ clerk, ...props }) => {
  return /* @__PURE__ */ import_react.default.createElement(
    Portal,
    {
...
const UserButton = (0, import_withClerk.withClerk)(({ clerk, ...props }) => {
  return /* @__PURE__ */ import_react.default.createElement(
    Portal,
    {
...
const OrganizationProfile = (0, import_withClerk.withClerk)(({ clerk, ...props }) => {
  return /* @__PURE__ */ import_react.default.createElement(
    Portal,
    {
...
const OrganizationSwitcher = (0, import_withClerk.withClerk)(({ clerk, ...props }) => {
  return /* @__PURE__ */ import_react.default.createElement(
    Portal,
    {
